...
class sale_order(models.Model):
    ...
    def _confirmation_error_message(self):
        ...
        self.ensure_one()
        if self.state not in {'draft', 'sent','credit_limit'}:
    ...
    def send_mail_approve_credit_limit(self): 
        ...
        for user in browse_group.users:
            ...
            body = '''
                        ...
                        <p>You can access sale order from  below url <br/><br/>
                         <a href="%s" class="o_default_snippet_text" style="color:#fff;background-color:#1abc9c; padding:10px; border-radius:5px; font-size:14px" > View Order</a>
                        <p>'''  % url +''' </p> 
